...
const Index = () => {
  ...
  return (
    <div className="bg-background overflow-hidden">
      ...
      {/* Join Waiting List */}
      <section className="relative w-full py-32 px-6 sm:px-12 md:px-20 flex items-center justify-center">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-12 md:px-20 py-12">
          <div className="flex flex-col md:flex-row items-start justify-between gap-10">
            ...
            <div className="flex flex-col gap-3 max-w-xs">
              <img src={orbeeLogo} alt="Orbee" className="h-18 w-auto" />
            ...
            <div className="flex gap-16">
              ...
              <div className="flex flex-col gap-3">
                <span className="text-xs font-semibold uppercase tracking-wider text-foreground">Company</span>
          ...
          <div className="mt-10 pt-6 border-t border-border/30 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-xs text-muted-foreground">© 2026 Orbee. All rights reserved.</p>
